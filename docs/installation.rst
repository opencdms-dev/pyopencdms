...
This is the preferred method to install opencdms, as it will always install the most recent stable release.
...
The sources for opencdms can be downloaded from the `Github repo`_.
